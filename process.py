...
def start_client(process_id, port, peers, network_delay_range):
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Lamport Clock Mutual Exclusion Process with Network Delays")
    ...
    client_thread = threading.Thread(
        target=start_client, 
        args=(process_id, port, peer_ports, network_delay_range)
    )
